                    ...
                    <div className="bg-gray-50 dark:bg-gray-800 p-4 rounded-lg">
                      <div className="text-gray-800 dark:text-gray-100 leading-loose">
                        {selectedHistory.tokens.map((token, index) => {
                          ...
                          return (
                            <span key={index} className="word-unit-wrapper tooltip inline-block mr-2 mb-2">
          ...
          <div className="bg-white dark:bg-gray-800 rounded-lg shadow-xl max-w-md w-full mx-auto">
            <div className="p-6">
              ...
              <div className="space-y-4">
                {/* 格式选择 */}
                <div>
                  <label className="block md-typescale-body-medium text-gray-700 dark:text-gray-300 mb-2">
                    导出格式
                  </label>
                  <select
                ...
                <div className="space-y-2">
                  <label className="flex items-center">
                    <input
                      ...
                      onChange={(e) => setExportOptions(prev => ({ ...prev, includeTranslation: e.target.checked }))}
                      className="mr-2"
                    />
